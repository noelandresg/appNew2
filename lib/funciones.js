...
function validateForm() {
    ...
    if (x == null || x == "") {
        ...
        band = false;
        return band;
    } else if (bmsServer == null || bmsServer == "") {
...
function inicio() {        
         nuevoPedido();
         $('#listaEstab').empty();
         //$('#establecimientos').css('visibility','hidden');
...
function llenaSelect(codigoUsuario){ //Recibe un codigo de usuario, consume el ws GetEstabs y llena un Select 
         ...
         var url = "http://bmsandroid.net.mandrake.arvixe.com/api/sesion/GetEstabs",
         data = {},
...
$(document).ready(function() {
    ...
    $("#btnIniciar").click(function() {
     ...
     password = $("#text2").val(),
     estab = "1",
     url = "http://bmsandroid.net.mandrake.arvixe.com/api/sesion/GetUsuario",
     //data = {},
     success = function(data) {
         if (data.codigo == "") {
 ...
 $('#config_btnProbar').click(function(){
    ...
    if (bmsServer == ""){
     ...
     var url = "http://bmsandroid.net.mandrake.arvixe.com/api/General/GetProbarConexion",
 ...
 $('#clienteDetalle_btnAceptar').click(function() {
     ...
     function actualizaTotalesProducto( cant ){
        ...
        bmsProdImporte = prodObj.precioUC * cant;
     ...
     $(document).on("pageinit", "#buscaProducto", function() {
      ...
      function addProducto(val) {
         ...
         var url = "http://bmsandroid.net.mandrake.arvixe.com/api/Productos/GetProducto";
         var data = {};
     ...
     function addCliente(val) {
         ...
         var url = "http://bmsandroid.net.mandrake.arvixe.com/api/Clientes/GetCliente";
         var data = {};
         var html = '<option value="' + '' + '">' + "Seleccione..." + '</option>';
         var success = function(data) {
             if (data.codigo !== "") {
