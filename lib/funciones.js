    ...
    $(document).on( "pageshow", "#pedidoDetalle", function() {
        ...
        var length = bmsLineaDetalle.length,
            ...
            for (i = 0; i < length; i++) {
                ...
                html +=  "<li data-value='"+obj.codigo+"'><a href'"+"#"+"''><p>"+ obj.descripcion +"</p><p class="+"topic"+"><strong>Cant: </strong>"+ obj.cantidad+"</p><p class="+"topic"+"><strong>Unidad: </strong>"+obj.unidadAbrev+"</p><p><strong>Importe: </strong>"+numeral(obj.importe).format('$0,0.00')+"</p><p><strong>IVA: </strong>"+numeral(obj.iva).format('$0,0.00')+"</p><p><strong>TOTAL: </strong>"+numeral(obj.total).format('$0,0.00')+"</p></a><a href="+"#"+" class="+"delete"+">Delete</a></li>";
            }
            $('#list').append(html);
            ...
            if ( transition ) {
                listitem
                    ...
                    .on( "webkitTransitionEnd transitionend otransitionend", function() {
                        ...
                        alert("Item eliminado index :" + JSON.stringify(eliminado));
                        listitem.remove();
